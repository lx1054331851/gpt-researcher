            ...
            {!isOpen ? (
              ...
              >
                <div className="flex justify-between items-center mb-5 sm:mb-6">
                  <h2 className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">{t("sidebar.researchHistory")}</h2>
                  <button
                    onClick={toggleSidebar}
                ...
                <div className="overflow-y-auto h-[calc(100vh-150px)] sm:h-[calc(100vh-190px)] pr-1 custom-scrollbar">
                  {history.length === 0 ? (
                    <div className="text-center py-8 sm:py-10 px-4">
                      ...
                      <h3 className="text-lg font-medium text-gray-300 mb-2">{t("sidebar.noHistoryTitle")}</h3>
                      <p className="text-sm text-gray-400">{t("sidebar.noHistoryDescription")}</p>
                    </div>
                  ) : (
                      ...
                      {history.map((item) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            aria-label={t("sidebar.deleteResearch")}
                          >
